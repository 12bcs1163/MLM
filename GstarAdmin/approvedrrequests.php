                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table id="customers2" class="table datatable">
											...
											<?php
											$sno=1;
											$data = $obj->get_one_record("select * from payments where Status='Paid' order by WithID DESC");
											foreach($data as $val)
											{
                                                ...
                                                <tr>
                                                 ...
                                                 <td><strong><?php echo $val['TotalAmount']; ?> </strong></td>
                                                  ...
                                                  <td><strong><?php echo $val['PaymentMode']; ?> </strong> </td>
												    ...
												    <td><strong><a href="approvedrequests.php?delid=<?php echo $val['WithID']; ?>" > Delete Request</a> </strong> </td>
                                                </tr>
