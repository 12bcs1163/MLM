<?php include'head.php' ?>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> My Referrals</h2>
                </div>
                <!-- END PAGE TITLE -->                
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">My Referrals</h3>
                                    ...
                                    <div class="table-responsive">
                                        <table id="customers2" class="table datatable">
											...
											<?php
													...
													$data = $obj->get_one_record("select * from Registration where DirectID='".$obj->userID."'");
													foreach($data as $val)
													{
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Rs. <?php echo $val['amount']; ?></td>
													   <td>Rs. <?php echo $val['amount']*$obj->referal_percent/100; ?></td>
