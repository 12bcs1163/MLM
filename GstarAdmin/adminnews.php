<?php include'head.php' ?>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> News and Updates</h2>
                </div>
                <!-- END PAGE TITLE -->   
				...
				if(!empty($_GET['id']))
				{
					...
					$obj->mysqli2->query("delete from news where NewsID='".$_GET['id']."'");
...
$id=$_GET['newsid'];
	 $obj->update_news(array_filter($_POST),$id);
...
$_POST['NewsDateTime']=$obj->today_date;
	 $obj->create_news(array_filter($_POST));
...
?>
                ...
                <div class="page-content-wrap">
					...
					<div class="col-md-10 col-sm-10 col-xs-12">
                                ...
                                <div class="panel-body form-group-separated">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-5 col-xs-5">
                                            <input type="text" placeholder="Message Title" class="form-control" name="Title" reqiured/ >
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-5 col-xs-5">
                                            <input type="text" placeholder="User ID" class="form-control" name="userid" id="topupuserid" reqiured/ > <div id="showname"></div>
						...
						$data1 = $obj->get_one_record("select * from news where NewsID='".$_GET['newsid']."'");
						$data1=$data1[0];
						$title=$data1['Title'];
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <h3><span class="fa fa-pencil"></span> Update News : </h3>
                                </div>
                                <div class="panel-body form-group-separated">
...
<th>User Id</th>
											...
											$data = $obj->get_one_record("select * from news");
											//print_r($data);
											foreach($data as $val)
											{
 ...
 <td><?php echo $val['userid']; ?></td>
                                                    ...
                                                    <td><?php echo $val['NewsDateTime']; ?> </td>
                                                       ...
                                                       <td> <a href="adminnews.php?id=<?php echo $val['NewsID']; ?>"><button type="button" class="btn btn-danger" name="generate"> Delete </button></a></td>
                                                </tr>
