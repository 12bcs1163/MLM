<?php include'head.php' ?>
				...
				if(!empty($_GET['id']))
				{
					...
					$obj->mysqli2->query("delete from adnews where NewsID='".$_GET['id']."'");
...
$id=$_GET['newsid'];
	 $obj->update_news2(array_filter($_POST),$id);
...
$_POST['NewsDateTime']=$obj->today_date;
	 $obj->create_news2(array_filter($_POST));
...
?>
                ...
                <div class="page-content-wrap">
					...
					<div class="col-md-10 col-sm-10 col-xs-12">
						...
						$data1 = $obj->get_one_record("select * from adnews where NewsID='".$_GET['newsid']."'");
						$data1=$data1[0];
						$title=$data1['Title'];
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table id="customers2" class="table datatable">
											...
											$data = $obj->get_one_record("select * from adnews");
											//print_r($data);
											foreach($data as $val)
											{
											...
											?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $val['NewsDateTime']; ?> </td>
                                                       ...
                                                       <td> <a href="adminnewsadd.php?id=<?php echo $val['NewsID']; ?>"><button type="button" class="btn btn-danger" name="generate"> Delete </button></a></td>
                                                </tr>
