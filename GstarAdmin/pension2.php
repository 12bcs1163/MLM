...
$threepercent=$totalcollection*20/100;

$data = $obj->get_one_record("select * from Registration where princepoolstatus='1' order by Id DESC");


if(!empty($_GET['delpayid']))
{
    
    $obj->mysqli2->query("delete from campains2 where payid='".$_GET['delpayid']."' and type='Pension2'");
    
      $obj->mysqli2->query("delete from payments where TranID='".$_GET['delpayid']."' and PaymentMode='Pension2'");
...
$d=$obj->get_one_record("select * from campains2 where payid='".$payid."' and type='Pension'");

if(empty($d))
{
    
  $q="insert into campains2 (amount,datetime,payid,type,perhead,totalusers) values ('".$amount."','".strtotime('NOW')."','".$payid."','Pension2','".$perhead."','".count($data)."')";
  $obj->mysqli2->query($q);
...
?>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span>All Prince Pool Holder</h2>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">All Users <a href="loadlist.php" target="_blank"><button class="btn btn-success">Refresh List</button></a></h3>
...
?>) </th>
                                                   <th colspan="3">Total 20 % Amount (Rs. <?php
...
$data2 = $obj->get_one_record("select * from campains2 where type='pension2' order by Id DESC");
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="pension2.php?delpayid=<?php echo $val['payid']; ?>" onclick="return confirm('Do you really want to delete <?php echo $val['payid']; ?>')">Delete</a>
                                                    </td>
                                                    ...
                                                    <td><a href="pchart2.php?payid=<?php echo $val['payid']; ?>">List Users</a></td>
