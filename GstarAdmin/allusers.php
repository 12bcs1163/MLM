                                    ...
                                    <div class="table-responsive">
                                        <table id="customers2" class="table datatable">
											...
											<?php
													...
													$data = $obj->get_one_record("select * from Registration order by Id DESC");
													foreach($data as $val)
													{
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a href="editprofile.php?id=<?php echo $val['Id']; ?>" target="_blank">Profile</a></td>
                                                    <td><a href="allusers.php?delid=<?php echo $val['UserID']; ?>"  onClick="return myFunction()">Delete</a></td>
                                                </tr>
