<?php include'head.php' ?> 
           ...
           <div class="page-title">                    
                    <h2><span class="fa fa-dollar"></span> Partner Income History</h2>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Partner Income History</h3>
                                ...
                                <?php include("error.php"); ?>
                                    <div class="table-responsive">
                                        <table id="customers2" class="table datatable">
											...
											$data = $obj->get_one_record("select * from payments where PaymentType='Partnerincome' order by WithID DESC");
											$closing=0;
											foreach($data as $val)
											{
